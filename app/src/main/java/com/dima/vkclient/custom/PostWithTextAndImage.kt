...
import kotlinx.android.synthetic.main.view_post_text_image.view.*

class PostWithTextAndImage @JvmOverloads constructor(
    context: Context,
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.view_post_text_image, this, true)
    }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        children.forEach { view ->
            ...
            when (view) {
                ...
                postContentText, postContentImage -> {
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        if (postContentImage.visibility != View.GONE) {
            postContentImage.layout(
                currentLeft,
                currentTop,
                currentLeft + postContentImage.measuredWidth,
                currentTop + postContentImage.measuredHeight + postContentImage.marginTop
            )
